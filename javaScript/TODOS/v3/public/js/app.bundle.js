...
(function () {
  ...
  var numCompleted = document.querySelector('#completedTodos');
  var numActive = document.querySelector('#activeTodos');
  var nav = document.querySelector('.nav');
  var navItems = document.querySelectorAll('.nav li');
  var allChecked = document.querySelector('#chk-allComplete');
  var delCompleted = document.querySelector('#btn-removeCompletedTodos');

  function renderHTML(state) {
    if (state === 'active') {
      selectTodos = todos.filter(function (todo) {
    ...
    numCompleted.innerHTML = selectTodos.filter(function (todo) {
      return todo.completed;
    }).length;
    numActive.innerHTML = selectTodos.filter(function (todo) {
      return !todo.completed;
    }).length;
  }
  ...
  inputTodo.addEventListener('keyup', function (e) {
    ...
    var newTodo = { id: getNextID(), content: inputTodo.value, completed: false };

    if (e.keyCode !== 13 || !inputTodo.value) return;

    _axios2.default.post('/todos', newTodo).then(function () {
  ...
  nav.addEventListener('click', function (e) {
    ...
    navItems.forEach(function (todo) {
      return todo.className = navItem.id === todo.id ? 'active' : '';
    });
  ...
  list.addEventListener('change', function (e) {
    ...
    _axios2.default.patch('/todos/' + e.target.id, { completed: !completed }).then(function () {
  ...
  allChecked.addEventListener('change', function (e) {
    var _todos = todos,
        completed = _todos.completed;

    _axios2.default.patch('/todos/', e.target.checked ? { completed: true } : { completed: false }).then(function () {
      todos = todos.map(function (todo) {
        return e.target.checked ? Object.assign({}, todo, { completed: true }) : Object.assign({}, todo, { completed: false });
      });
